         ...
         child: Container(
          child: Column(
            ...
            const  Padding(
                ...
                child: Text("Tell us who you are",style: TextStyle(decoration: TextDecoration.none,fontSize: 28,fontWeight: FontWeight.bold),),
              ),
              Padding(
               ...
               Padding(
                ...
                child: TextFormField(controller: lastnamec,
                  decoration: InputDecoration(
                    hintText: "Last Name",
                    labelText: "Last Name",
                    border: OutlineInputBorder(borderRadius: BorderRadius.circular(3)),
            ...
            child: TextField(readOnly: true,
              ...
              decoration: InputDecoration(
               ...
               border: OutlineInputBorder(borderRadius: BorderRadius.circular(3)),
                label:Text('Birthday',style: TextStyle(color:Colors.black),) ,labelStyle: TextStyle(
      ...
      child: Padding(
        ...
        child:  Text('${selectedOption}',style: TextStyle(fontSize: 15,color: Colors.black),),
              ...
              Padding(
                ...
                child: Text("Your profile is public by default.Change your\nvisibility any time in Privacy Control",style: TextStyle(fontSize: 17,color: Colors.grey.shade700),),
              ),
              ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: Colors.grey.shade400, fixedSize: Size(340, 45)), onPressed: (){
