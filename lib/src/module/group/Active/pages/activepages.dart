                    ...
                    children: [
                     ...
                     child: Padding(
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor:Color.fromARGB(255, 228, 33, 16), fixedSize: Size(600, 40)), onPressed: (){}, child: Text("Create a Group Challenge",style: TextStyle(fontWeight: FontWeight.w600),)),
                      ),
                      Padding(
                        padding: const EdgeInsets.fromLTRB(17,15,17,20),
                        child: OutlinedButton(style: OutlinedButton.styleFrom( fixedSize: Size(600, 40),side: BorderSide( color: Colors.red)), onPressed: (){}, child: Text("Subscribe Now",style: TextStyle(fontWeight: FontWeight.w600,color: Colors.red,fontSize: 13),)),
                      )
