...
double pageHPadding = 10;
double pageVPadding = 8;
double pageTitleSize = 18;
double videoIconSize = 22.sp;
double pageTextSize = 14;
double pageSmallTextSize = 10;
double pageIconSize = 16;
double pageSmallIconSize = 12;